...
typedef enum {
  INDEXSTOREDB_SYMBOL_SUBKIND_NONE = 0,
  INDEXSTOREDB_SYMBOL_SUBKIND_CXXCOPYCONSTRUCTOR = 1,
  INDEXSTOREDB_SYMBOL_SUBKIND_CXXMOVECONSTRUCTOR = 2,
  INDEXSTOREDB_SYMBOL_SUBKIND_ACCESSORGETTER = 3,
  INDEXSTOREDB_SYMBOL_SUBKIND_ACCESSORSETTER = 4,
  INDEXSTOREDB_SYMBOL_SUBKIND_SWIFTACCESSORWILLSET = 5,
  INDEXSTOREDB_SYMBOL_SUBKIND_SWIFTACCESSORDIDSET = 6,
  INDEXSTOREDB_SYMBOL_SUBKIND_SWIFTACCESSORADDRESSOR = 7,
  INDEXSTOREDB_SYMBOL_SUBKIND_SWIFTACCESSORMUTABLEADDRESSOR = 8,
  INDEXSTOREDB_SYMBOL_SUBKIND_SWIFTEXTENSIONOFSTRUCT = 9,
  INDEXSTOREDB_SYMBOL_SUBKIND_SWIFTEXTENSIONOFCLASS = 10,
  INDEXSTOREDB_SYMBOL_SUBKIND_SWIFTEXTENSIONOFENUM = 11,
  INDEXSTOREDB_SYMBOL_SUBKIND_SWIFTEXTENSIONOFPROTOCOL = 12,
  INDEXSTOREDB_SYMBOL_SUBKIND_SWIFTPREFIXOPERATOR = 13,
  INDEXSTOREDB_SYMBOL_SUBKIND_SWIFTPOSTFIXOPERATOR = 14,
  INDEXSTOREDB_SYMBOL_SUBKIND_SWIFTINFIXOPERATOR = 15,
  INDEXSTOREDB_SYMBOL_SUBKIND_SWIFTSUBSCRIPT = 16,
  INDEXSTOREDB_SYMBOL_SUBKIND_SWIFTASSOCIATEDTYPE = 17,
  INDEXSTOREDB_SYMBOL_SUBKIND_SWIFTGENERICTYPEPARAM = 18,
...
typedef enum {
  ...
  INDEXSTOREDB_SYMBOL_PROPERTY_SWIFT_ACCESSCONTROL_LESSTHANFILEPRIVATE = 1 << 17,
  INDEXSTOREDB_SYMBOL_PROPERTY_SWIFT_ACCESSCONTROL_FILEPRIVATE         = 1 << 18,
  INDEXSTOREDB_SYMBOL_PROPERTY_SWIFT_ACCESSCONTROL_INTERNAL            = 1 << 18 | 1 << 17,
  INDEXSTOREDB_SYMBOL_PROPERTY_SWIFT_ACCESSCONTROL_PACKAGE             = 1 << 19,
  INDEXSTOREDB_SYMBOL_PROPERTY_SWIFT_ACCESSCONTROL_SPI                 = 1 << 19 | 1 << 17,
  INDEXSTOREDB_SYMBOL_PROPERTY_SWIFT_ACCESSCONTROL_PUBLIC              = 1 << 19 | 1 << 18,
...
/// Returns the language-specific subkind of the given symbol.
INDEXSTOREDB_PUBLIC indexstoredb_symbol_subkind_t
indexstoredb_symbol_subkind(_Nonnull indexstoredb_symbol_t);
